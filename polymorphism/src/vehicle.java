...
class car extends Vehicle
{
	...
	void brake()
	{
		System.out.println("breyak by hand break");
	}
...
class bike extends Vehicle
{
	...
	void brake()
	{
		System.out.println("breyak by leg break");
	}
...
class bus extends Vehicle
{
	...
	bus() {
		super();
		this.sittingcapacity=60;
	}

	bus(String model,String brand,String color,int year,int sittingcapacity) {
		super(model,brand,color,year);
	...
	void setSittingcapacity(int sittingcapacity) {
		this.sittingcapacity = sittingcapacity;
	}
	...
	{
		super.display();
		System.out.println("sittingcapacity"+this.sittingcapacity);
	}
	
	void brake()
	{
		System.out.println("breyak by 2 leg break");
	}
 ...
 class testvehicle {
	...
	public static void main(String[] args) {
		...
		System.out.println("---------------------------------------");
			...
			System.out.println("---------------------------------------");
			v1=new car("model","tesla","grey",2025,5,"electic");
			...
			v1=new bike(a,b,c,d,e,f);
			
			v1.brake();
			
			v1=new bus("mod1l222","lalpari","red",2000,100);
			v1.brake();
	}

...
class Laptop extends computer {
 ...
 class testDevice {
	...
	public static void main(String[] args) {
		...
		computer c1=new computer("Dell",70000,"black","i7","16gb");
		c1.display();
		System.out.println();
		
		 Laptop l1 = new Laptop("lenovo",90000,"silver","i10","48gb", 2.5);
	      l1.display();
	      System.out.println();
		
	        Laptop l2 = new Laptop("apple",100000,"silver","i10","49gb", 2.9);
	        l2.display();
